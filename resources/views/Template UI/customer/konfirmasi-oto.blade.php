...
@section('content')
    ...
    <form action="{{ route('otomotifs.purchased', $data->id) }}" method="POST">
        ...
        <div class="form-input">
            ...
            <input type="text" class="inp-disable" name="jenis" value="{{ $data->merk }}" disabled>
            <p for="">{{ $data->jenis }}</p>

            <label for="">Tahun Pembuatan :</label>
            <input type="date" class="inp-disable" name="tanggal_berangkat" value="{{ $data->tahun }}"disabled>
            <p for="">{{ $data->tanggal_berangkat }}</p>

            <label for="">Kapasitas Mesin :</label>
            <input type="text" class="inp-disable" name="durasi" value="{{ $data->cc}}" disabled>
            <p for="">{{ $data->durasi }} Hari</p>

            <label for="">Transmisi :</label>
            <input type="text" class="inp-disable" name="durasi" value="{{ $data->transmisi}}" disabled>
            <p for="">{{ $data->durasi }} Hari</p>
