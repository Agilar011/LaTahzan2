...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::get('/tampilkandatabeliumroh/{id}', [UmrohController::class, 'tampilkandatabeliumroh'])->name('konfirmasi-umroh')->middleware('hakAkses');
    ...
    Route::get('/deletedataumroh/{id}', [UmrohController::class, 'deletedataumroh'])->name('deletedataumroh')->middleware('hakAkses');
    Route::post('/updatedatabeliumroh/{id}', [UmrohController::class, 'updatedatabeliumroh'])->name('updatedatabeliumroh')->middleware('hakAkses');
    Route::get('/insertjemaah/{id}', [UmrohController::class, 'createjemaah'])->name('identitasjemaah')->middleware('hakAkses');
    Route::post('/insertjemaah/{id}', [UmrohController::class, 'storejemaah'])->name('storejemaah')->middleware('hakAkses');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/tambahProp', [PropertiController::class, 'tambahProp'])->name('tambahProp')->middleware('hakAkses');
    Route::get('/crd-umroh', [UmrohController::class, 'showApprovedNotPurchasedUmrohs'])->name('etalase-umroh')->middleware('hakAkses');
    Route::post('/insertdataprop', [PropertiController::class, 'insertdataprop'])->name('insertdataprop')->middleware('hakAkses');
    ...
    Route::middleware('auth')->post('/Propertys/{property}/purchased', [PropertiController::class, 'purchase'])->name('propertys.purchased')->middleware('hakAkses');
    Route::get('/trx-properti', [PropertiController::class, 'showPurchasedPropertys'])->name('transaksi-prop')->middleware('hakAkses');
    Route::get('/tampilkandataprop/{id}', [PropertiController::class, 'tampilkandataprop'])->name('tampilkandataprop')->middleware('hakAkses');
    Route::post('/updatedataprop/{id}', [PropertiController::class, 'updatedataprop'])->name('updatedataprop')->middleware('hakAkses');
    Route::get('/deletedataprop/{id}', [PropertiController::class, 'deletedataprop'])->name('deletedataprop')->middleware('hakAkses');
});

// Rute Otomotif
Route::middleware('auth')->group(function () {
    Route::get('/input-oto', [OtomotifController::class, 'index'])->name('otomotif')->middleware('hakAkses');
    Route::get('/tambahOto', [OtomotifController::class, 'tambahOto'])->name('tambahOto')->middleware('hakAkses');
    Route::post('/insertdataoto', [OtomotifController::class, 'insertdataoto'])->name('insertdataoto')->middleware('hakAkses');
    ...
    Route::middleware('auth')->post('/Otomotif/{otomotif}/purchased', [OtomotifController::class, 'purchase'])->name('otomotifs.purchased')->middleware('hakAkses');
    Route::get('/trx-oto', [OtomotifController::class, 'showPurchasedOtomotifs'])->name('transaksi-oto')->middleware('hakAkses');
    Route::get('/tampilkandataoto/{id}', [OtomotifController::class, 'tampildataoto'])->name('tampilkandataoto')->middleware('hakAkses');
    Route::post('/updatedataoto/{id}', [OtomotifController::class, 'updatedataoto'])->name('updatedataoto')->middleware('hakAkses');
    Route::get('/deletedataoto/{id}', [OtomotifController::class, 'deletedataoto'])->name('deletedataoto')->middleware('hakAkses');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard-oto-customer', [OtomotifController::class, 'dashboardOto'])->name('dashboardOto')->middleware('hakAkses');
